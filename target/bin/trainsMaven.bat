...
%JAVACMD% %JAVA_OPTS% %EXTRA_JVM_ARGUMENTS% -classpath %CLASSPATH_PREFIX%;%CLASSPATH% -Dapp.name="trainsMaven" -Dapp.repo="%REPO%" -Dbasedir="%BASEDIR%" com.mycompany.trainsmaven.Trains %CMD_LINE_ARGS%
